...
if __name__ == "__main__":
    ...
    for ser in SERIES:
        ...
        for a, b in PAIRS:
            for h in HORIZONS:
                ...
                L = h + 1
                if (La < L or Lb < L
                        or not np.isfinite([ca, cb, sa, sb]).all()):
                    continue        # either window is truncated by the sample end
                diff = ca - cb
    ...
    def cell(a, b, h):
        ...
        return f"${r['diff_%'].iloc[0]:+.2f}{sup}{pad}$"
    ...
    lines = [
        ...
        r"\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} l rrrr @{}}", r"\toprule",
