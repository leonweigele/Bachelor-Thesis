...
three days, producing exact zero returns on 3.5~percent of Brent trading days, 0.6~percent of
gold days and 4.3~percent of days of the broad dollar index. A few such days fall inside event
...
quoted to two decimals and can be genuinely unchanged. Recomputing the headline cross-event
statistic without the zero days moves its $t$ from $-4.11$ to $-4.0$, so the effect on the
reported statistics is negligible.}
